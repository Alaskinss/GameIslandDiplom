            ...
            <DialogPanel
              ...
              <form @submit.prevent="onSubmit">
                <div class="bg-white px-4 pt-5 pb-4">
                  <CustomInput class="mb-2" v-model="product.title" label="Название"/>
                  <CustomInput type="file" class="mb-2" label="Product Image" @change="file => product.image = file"/>
                  <CustomInput type="textarea" class="mb-2" v-model="product.description" label="Описание"/>
                  <CustomInput type="number" class="mb-2" v-model="product.price" label="Цена" prepend="$"/>
                  <CustomInput type="checkbox" class="mb-2" v-model="product.published" label="Опубликовать"/>
                </div>
