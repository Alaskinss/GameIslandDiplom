  ...
  <div v-if="order">
    ...
    <div>
      ...
      <table>
        ...
        <tr>
          <td class="font-bold py-1 px-2">Дата заказа</td>
          <td>{{ order.created_at }}</td>
        </tr>
        <tr>
          <td class="font-bold py-1 px-2">Статус заказа</td>
          <td>
        ...
        <tr>
          <td class="font-bold py-1 px-2">Сейчас</td>
    ...
    <!--  Customer Details-->
    <div>
      <h2 class="text-xl font-semibold mt-6 pb-2 border-b border-gray-300">Детали клиента</h2>
      <table>
        <tbody>
        <tr>
          <td class="font-bold py-1 px-2">Логин</td>
          <td>{{ order.customer.first_name }} {{ order.customer.last_name }}</td>
        </tr>
        <tr>
          <td class="font-bold py-1 px-2">Почта</td>
          <td>{{ order.customer.email }}</td>
        </tr>
        <tr>
          <td class="font-bold py-1 px-2">Телефон</td>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
      <div>
        <h2 class="text-xl font-semibold mt-6 pb-2 border-b border-gray-300">Адрес выставления счета</h2>
      ...
      <div>
        <h2 class="text-xl font-semibold mt-6 pb-2 border-b border-gray-300">Адрес доставки</h2>
