        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            <div class="bg-white p-3 shadow rounded-lg md:col-span-2">
                <form x-data="{
                    ...
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Детали профиля</h2>
                    ...
                    <h2 class="text-xl mt-6 font-semibold mb-2">Адрес для выставления счета</h2>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                            <x-input
                                type="text"
                        ...
                        <div>
                            <template x-if="billingCountryStates">
                                <x-input type="select"
                                         ...
                                         class="w-full focus:border-purple-600 focus:ring-purple-600 border-gray-300 rounded">
                                    <option value="">Выбор штата</option>
                    ...
                    <div class="flex justify-between mt-6 mb-2">
                        ...
                        <label for="sameAsBillingAddress" class="text-gray-700">
                            <input @change="$event.target.checked ? shippingAddress = {...billingAddress} : ''"
                                   ...
                                   class="text-purple-600 focus:ring-purple-600 mr-2"> Выставление счета о покупке
                        </label>
                    </div>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                    ...
                    <x-button class="w-full">Обновить</x-button>
                </form>
            </div>
            <div class="bg-white p-3 shadow rounded-lg">
                <form action="{{route('profile_password.update')}}" method="post">
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Обновить пароль</h2>
                    <div class="mb-3">
                        <x-input
                            type="password"
                            name="old_password"
