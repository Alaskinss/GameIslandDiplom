<x-app-layout>
    <form method="POST" action="{{ route('login') }}" class="w-[400px] mx-auto p-6 my-16">
        ...
        @csrf
        <div class="mb-4">
            <x-input type="email" name="email" placeholder="Введите вашу почту" :value="old('email')"/>
        </div>
        <div class="mb-4">
            <x-input type="password" name="password" placeholder="Введите пароль" :value="old('password')" />
        </div>
